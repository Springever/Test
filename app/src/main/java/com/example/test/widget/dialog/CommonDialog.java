package com.example.test.widget.dialog;
...
public class CommonDialog extends Dialog {
	...
	public void setPositiveButton(int textRes, boolean highlight, OnClickListener l) {
	...
	public void setNegativeButton(int textRes, OnClickListener l) {
		mButtonLayout.setVisibility(View.VISIBLE);
