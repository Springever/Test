...
var DEFAULT_URL = 'http://130.1.11.177:9080/mmc';

export class WebViewCustom extends React.Component {
  state = {
    url: DEFAULT_URL,
      ...
      <View style={[styles.container, { height: 200 }]}>
        ...
        <View style={styles.container}>
          <WebView
            ...
            source={require('../file/baidu/baidu.html')}
    ...
    return (
      <View>
        <WebView
          ...
          source={{uri: 'http://130.1.11.143:9080/hmmc'}}
          scalesPageToFit={true}
        />
        <View style={styles.buttons}>
    ...
    render(): React.Element<any> {
      return (
        <WebView
          ...
          source={require('../file/jd/jd.html')}
          scalesPageToFit={true}
        />
      );
    }
    ...
    render(): React.Element<any> {
      return (
        <WebView
          ...
          source={{
            uri: 'http://130.1.11.143:9080/hmbank/collectWill/download/zxfile.do',
            method: 'POST',
            body: 'fileName=20141008tleBaldridge001h990.jpg'
          }}
