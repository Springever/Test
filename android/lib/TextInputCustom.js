...
export class TextEvents extends React.Component {
  state = {
    curText: '<No Event>',
    prevText: '<No Event>',
    prev2Text: '<No Event>',
...
export class Rewrite extends React.Component {
  constructor(props) {
    super(props);
    this.state = {text: ''};
  }
...
export class TokenizedText extends React.Component {
  constructor(props) {
    super(props);
...
export class BlurOnSubmit extends React.Component {
...
export class ToggleDefaultPadding extends React.Component {
  constructor(props) {
    super(props);
...
exports.textInputCustomType = [
  ...
  },
  {
    ...
    render: function() {
      ...
      var textInputType = autoCapitalizeTypes.map((type) => {
        return (
          <TextInput
            key={type}
            autoCapitalize={type}
      ...
      return <View>{textInputType}</View>;
    }
  },
  {
    title: 'Auto-correct',
  ...
  },
  {
    ...
    render: function() {
      ...
      var textInputType = keyboardTypes.map((type) => {
        return (
          <TextInput
            key={type}
            keyboardType={type}
  ...
  },
  {
    ...
    render: function(): React.Element { return <BlurOnSubmit />; },
  },
  {
    title: 'Event handling',
    render: function(): React.Element { return <TextEvents />; },
  },
  {
  ...
  },
  {
    ...
    render: function() {
      ...
      var textInputType = returnKeyTypes.map((type) => {
        return (
          <TextInput
            key={type}
            returnKeyType={type}
      ...
      return <View>{textInputType}{types}</View>;
    }
  },
  {
    title: 'Inline Images',
  ...
  },
  {
    ...
    render: function(): React.Element { return <ToggleDefaultPadding />; },
  },
  {
