...
//	private String m_UPDATE_SERVER = "appnotifierfront.test.uae.uc.cn";
	 ...
	 * @return 
	 */
	public List<LocalApps.LocalAppInfo> requestLocalData() {
		if (!mHasScannedLocal) {
	 ...
	 */
	public List<LocalApps.LocalAppInfo> requestAllLocalPackage() {
		if (!mHasScannedLocal) {
			refreshLocalData(mAppContext);
		}
	...
	public LocalApps.LocalAppInfo requestLocalPackage(String packageName) {
