...
/**
 * Created by Springever on 2017/6/13.
 */
...
public class JsoupActivity extends BaseActivity {
    ...
    protected void initGui() {
        webView = (WebView) findViewById(R.id.webViewJsoup);
    ...
    public String test() {
        ...
        Document doc;
        try {
            doc = Jsoup.connect("http://130.1.11.177:9080/mmc").get();
...
//                str=doc.body().toString();
                ...
                //Elements ListDiv = doc.getElementsByTag("html");
                for (Element element : ListDiv) {
                    str = element.html();
