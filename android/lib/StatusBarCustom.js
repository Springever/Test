...
export const StatusBarHidden = React.createClass({
  getInitialState() {
    return {
      animated: true,
      hidden: false,
...
export const StatusBarStyle = React.createClass({
  getInitialState() {
    return {
      animated: true,
...
export const StatusBarNetworkActivity = React.createClass({
  getInitialState() {
    return {
...
const StatusBarBackgroundColor = React.createClass({
  getInitialState() {
    return {
      animated: true,
...
export const StatusBarTranslucent = React.createClass({
  getInitialState() {
    return {
      translucent: false,
    };
...
export const StatusBarStaticIOS = React.createClass({
  render() {
    return (
      <View>
        <TouchableHighlight
...
export const StatusBarStaticAndroid = React.createClass({
  render() {
    return (
      <View>
        <TouchableHighlight
...
const statusType = [{
  ...
  render() {
    return <StatusBarNetworkActivity />;
  },
  platform: 'ios',
}, {
  ...
  render() {
    return <StatusBarStaticIOS />;
  },
  platform: 'ios',
}, {
  title: 'StatusBar static API',
  render() {
    return <StatusBarStaticAndroid />;
  },
  platform: 'android',
}, {
