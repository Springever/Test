...
public class DataCache {
	...
	public synchronized DataCenter.Response loadCacheResponse(Context context, int dataId) {
	...
	public synchronized void saveResponseCache(Context context, int dataId, DataCenter.Response resp) {
